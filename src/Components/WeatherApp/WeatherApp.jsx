...
export const WeatherApp = () => {
    ...
    const search = async () => {
        ...
        searchHistory.innerHTML = searchHistory.innerHTML +     `<div class="historyRow">
                                                                    <div class = "cityHistory">${data.name}</div>
            ...
            <div id="searchHistory">
                ...
                <div id="historyRowWrap">
                    ...
                    {/* <div className="historyRow">
                        <div className = "cityHistory">123</div>
                        <div className = "timeHistory">456</div>
                        <div className="historySearchIcon" onClick ={()=>{research()}}>
                            <img src={historySearchIcon} alt="" />
                        </div>
                        <div className="historyDustbin">
                            <img src={dustbin} alt="" />
                        </div>
                    </div> */}
                </div>
